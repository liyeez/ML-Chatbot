...
base_path = '/z5133975/ChatBotAss2/0'

definitions = {'definitions': {'Dentist': {'type': 'object', 'required': ['name'], 'properties': {'name': {'type': 'string'}, 'location': {'type': 'string'}, 'specialization': {'type': 'string'}}}, 'Dentists': {'type': 'array', 'items': {'$ref': '#/definitions/Dentist'}}, 'ErrorModel': {'type': 'object', 'required': ['code', 'message'], 'properties': {'code': {'type': 'integer', 'format': 'int32'}, 'message': {'type': 'string'}}}}, 'parameters': {}}

validators = {
    ('dentists', 'GET'): {'args': {'required': [], 'properties': {'expression': {'type': 'string'}}}},
}

filters = {
    ('dentists', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/Dentists'}}, 400: {'headers': None, 'schema': {'type': 'string', 'example': 'Unable to parse query string'}}, 403: {'headers': None, 'schema': {'type': 'string', 'example': 'Not Found'}}},
}
