...
definitions = {'definitions': {'Dentist': {'type': 'object', 'required': ['name'], 'properties': {'name': {'type': 'string'}, 'location': {'type': 'string'}, 'specialization': {'type': 'string'}}}, 'ErrorModel': {'type': 'object', 'required': ['code', 'message'], 'properties': {'code': {'type': 'integer', 'format': 'int32'}, 'message': {'type': 'string'}}}}, 'parameters': {}}
...
filters = {
    ('dentists', 'GET'): {200: {'headers': None, 'schema': {'$ref': '#/definitions/Dentist'}}, 400: {'headers': None, 'schema': {'type': 'string', 'example': 'Unable to parse query string'}}, 403: {'headers': None, 'schema': {'type': 'string', 'example': 'Not Found'}}},
}
